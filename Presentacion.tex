	...
	\subsection{Pobres en $Ni$}
		\subsubsection{Fases obtenidas}
			\begin{frame}{Difracción por rayos X}
				\begin{figure}[H]
					\captionsetup[subfloat]{labelformat=empty}
					\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.09]{img/RX/NiPoor_500.png}} \qquad
					\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.09]{img/RX/NiPoor_600.png}} \\
					\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.09]{img/RX/NiPoor_700.png}} \qquad
			...
			\begin{frame}{Curvas de DSC}
				...
				\captionsetup[subfloat]{labelformat=empty}
					...
					\noindent\makebox[\linewidth][c]{
						\subfloat[Muestra tratada a $500 ^\circ C$]{\includegraphics[scale=0.06]{img/DSCNiPoor/500}}\qquad
						\subfloat[Muestra tratada a $600 ^\circ C$]{\includegraphics[scale=0.06]{img/DSCNiPoor/600}}} \\
					\noindent\makebox[\linewidth][c]{
						\subfloat[Muestra tratada a $700 ^\circ C$]{\includegraphics[scale=0.06]{img/DSCNiPoor/700}}\qquad
	...
	\subsection{Ricas en $Ni$}	
		\subsubsection{Fases obtenidas}
			\begin{frame}{Difracción por rayos X}
				\begin{figure}[H]
				\captionsetup[subfloat]{labelformat=empty}
					\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.1]{img/RX/NiRich_500.png}} \qquad
					\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.1]{img/RX/NiRich_600.png}} \\
					\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.076]{img/RX/NiRich_700.png}} \qquad
		...
		\subsubsection{Temperaturas de transformación}
			...
			\begin{frame}{Curvas de Resistividad}
				...
				\captionsetup[subfloat]{labelformat=empty}
					\centering
					\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.06]{img/Resistance_500_alt.png}} \qquad
					\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.06]{img/Resistance_600_alt.png}}\\
					\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.06]{img/Resistance_800_alt.png}} 
