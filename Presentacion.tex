	...
	\subsection{Pobres en $Ni$}
		\subsubsection{Fases obtenidas}
			...
			\begin{frame}{Imágenes obtenidas por TEM}
				...
				\captionsetup[subfloat]{labelformat=empty}
					\centering
					\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig24a.jpg}} \qquad
					\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig24b.jpg}} \\
					\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig24c.jpg}} \qquad
	...
	\subsection{Ricas en $Ni$}	
		\subsubsection{Fases obtenidas}
			...
			\begin{frame}{Imágenes obtenidas por TEM}
				 \begin{figure}[H]
				 	\captionsetup[subfloat]{labelformat=empty}
					\centering
					\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig27a.jpg}} \qquad
					\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig27b.jpg}} \\
					\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig27c.jpg}}	\qquad
					\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.2]{img/TEM/Fig27d.jpg}}
		...
		\begin{frame}
			\begin{figure}[H]
				\captionsetup[subfloat]{labelformat=empty}
				\noindent\makebox[\linewidth][c]{
					\subfloat[Muestra tratada a $500 ^\circ C$]{\includegraphics[scale=0.09]{img/DSCNiRich/500NiRich}}
					\subfloat[Muestra tratada a $600 ^\circ C$]{\includegraphics[scale=0.09]{img/DSCNiRich/600NiRich}}}\\
		...
		\begin{frame}{Curvas de Resistividad}
			...
			\captionsetup[subfloat]{labelformat=empty}
				\centering
				\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.08]{img/Resistance_500.png}} \qquad
				\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.08]{img/Resistance_600_alt.png}}\\
				\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.08]{img/Resistance_800.png}} 
